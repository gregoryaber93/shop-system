...
Profil uzytkownika przechowuje dane z UserService. Historia zamówień pochodzi z OrderService.
...
## Polling dla statusu zamówienia
...
- Email nie moze byc zmieniony na froncie; jest read-only.
- Waliduj dane wejsciowe: długość, format tel., itp.
- Po aktualizacji, invaliduj cache profilu i wyswietl potwierdzenie.
